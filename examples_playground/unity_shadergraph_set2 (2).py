...
def save_to_json(result, out_path: str = None):
    ...
    if out_path is None:
        out_path = os.path.join(tmp_dir, "unity_shadergraph_llm.json")
...
def save_to_markdown(result, out_path: str = None):
    ...
    if out_path is None:
        out_path = os.path.join(tmp_dir, "unity_shadergraph_llm.md")
