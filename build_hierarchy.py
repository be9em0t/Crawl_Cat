...
def build_hierarchy(flat_data: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    # Root URL
    root_url = "https://docs.unity3d.com/Packages/com.unity.shadergraph@17.4/manual/Node-Library.html"
...
if __name__ == "__main__":
    # Load the flat JSON
    with open('output/shadergraph_content_explore.json', 'r') as f:
        flat_data = json.load(f)

    # Build hierarchy
    hierarchy = build_hierarchy(flat_data)

    # Save nested JSON
    with open('output/shadergraph_hierarchy.json', 'w') as f:
        json.dump(hierarchy, f, indent=2)

    print("Hierarchical JSON saved to output/shadergraph_hierarchy.json")