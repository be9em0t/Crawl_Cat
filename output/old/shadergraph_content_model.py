...
class NodeLibrary(BaseModel):
    graph_nodes: List[Category] = Field(..., description="A list of categories for graph nodes.")
    block_nodes: List[Category] = Field(..., description="A list of categories for block nodes.")